...
let placesOfWorld : string[] = ["India", "USA", "China", "Japan", "Russia"]

//Print the array in its original order.
console.log(placesOfWorld);

//Print the array in alphabetical order without modifying the actual list.
let sortedPlacesOfWorld = placesOfWorld.slice().sort()
...
let reversedSortedPlacesOfWorld = sortedPlacesOfWorld.slice().reverse()
